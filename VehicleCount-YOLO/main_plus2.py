# vidoe: https://www.vecteezy.com/video/7957364-car-and-truck-traffic-on-the-highway-in-europe-poland-summer-day
import cv2
import numpy as np
import time
...
def process_video(input_file, output_file, config_file, weights_file, class_file, conf_threshold=0.5,
    ...
    while cap.isOpened():
        ...
        for box in vehicle_boxes:
            ...
            cv2.putText(frame, f"Vehicle {vehicle_count}", (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
